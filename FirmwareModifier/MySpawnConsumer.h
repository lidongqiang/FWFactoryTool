...
public:
	...
	static CString mkBootImgCmd(CString strExe,CString strKernel,CString strRamdisk,CString strOutputFile);
	...
	static CString CovertPressionBmpCmd(CString strExe,CString strSrcPath,CString strOutputDir);
	static CString CovertDtstoDtb(CString strExe);
	static CString CovertRunBat(CString strExe);
private:
